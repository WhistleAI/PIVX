...
In order to support loading of multiple wallets in whistle-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is whistle.cpp.
...
Changes to whistle.cpp
----------------------
whistle.cpp is the entry point into whistle-qt, and as such, will require some minor modifications to provide hooks for
