...
extern UniValue setzwislseed(const UniValue& params, bool fHelp);
extern UniValue getzwislseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzwisl(const UniValue& params, bool fHelp);
extern UniValue dzwislstate(const UniValue& params, bool fHelp);
