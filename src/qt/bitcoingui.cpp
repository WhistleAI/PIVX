                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Whistle AI Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WISL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Whistle AI: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zWISL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Whistle AI Core"), this);
    aboutAction->setStatusTip(tr("Show information about Whistle AI Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Whistle AI"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WISL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WISL addresses"));
    ...
    openAction->setStatusTip(tr("Open a WISL: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Whistle AI Core help message to get a list with possible command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Whistle AI Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Whistle P2P network", "", count));
}
...
{
    QString strTitle = tr("Whistle AI Core"); // default title
