...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zwislTracker->HasMintTx(hash))) {
            //zWISL stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZWISL;
...
bool IsZWISLType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZWISL:
        case TransactionRecord::ZerocoinMint:
        case TransactionRecord::ZerocoinSpend:
        case TransactionRecord::RecvFromZerocoinSpend:
        case TransactionRecord::ZerocoinSpend_Change_zWISL:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZWISL || type == TransactionRecord::MNReward) {
