                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzWISLPathCustom = GetArg("-zwislbackuppath", "");
    ...
    if(!strzWISLPathCustom.empty()) {
        ui->wallet_customzwislbackuppath->setText(QString::fromStdString(strzWISLPathCustom));
        ui->wallet_customzwislbackuppath_label->setVisible(true);
        ui->wallet_customzwislbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzWISLPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Whistle AI RPC console.") + "<br>" +
