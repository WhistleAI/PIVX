...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Whistle AI Core"),
     ...
     * override -datadir in the whistle.conf file in the default data directory
     * (to be consistent with whistled behavior)
     */
    if (dataDir != getDefaultDataDirectory())
