...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Whistle AI Core whistle-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  whistle-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wisl transaction") + "\n" +
                               "  whistle-tx [options] -create [commands]   " + _("Create hex-encoded wisl transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded whistle transaction
