...
RESOURCES += src/qt/whistle.qrc src/qt/whistle_locale.qrc

TRANSLATIONS += src/qt/locale/whistle_bg.ts \
                src/qt/locale/whistle_de.ts \
                src/qt/locale/whistle_en.ts \
                src/qt/locale/whistle_es.ts \
                src/qt/locale/whistle_fi.ts \
                src/qt/locale/whistle_fr.ts \
                src/qt/locale/whistle_it.ts \
                src/qt/locale/whistle_ja.ts \
                src/qt/locale/whistle_pl.ts \
                src/qt/locale/whistle_pt.ts \
                src/qt/locale/whistlx_ru.ts \
                src/qt/locale/whistle_sk.ts \
                src/qt/locale/whistle_sv.ts \
                src/qt/locale/whistle_vi.ts \
                src/qt/locale/whistle_zh_CN.ts \
                src/qt/locale/whistle_zh_TW.ts
