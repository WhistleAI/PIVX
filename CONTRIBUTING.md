Contributing to WhistleAI Core
============================

The WhistleAI Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WhistleAI Core project, and is not to be
confused with overall Network Protocol consensus changes.

Whether a pull request is merged into WhistleAI Core rests with the project merge
...
Patches that change consensus rules are considerably more involved than
...
The project leader is the release manager for each WhistleAI Core release.
